...
| `challenge_states.csv` | Challenge states | 410 | Challenge assignments with objectives, difficulty ratings, and ranks |
| `desired_outcomes.csv` | Desired outcomes | 95 | Weekly desired outcomes with status (COMPLETED, FAILED, STARTED, NOT_STARTED) |
